...
public class ResPermFormBean extends ActionForm {
	...
	private String hora;
	private String[] horas= {"08:00", "08:30", "09:00", "09:30", "10:00", "10:30", "11:00",
	...
	//private boolean l
	public ResPermFormBean() throws SQLException {
		inicializaSalasDB();
		inicializa();
		if(!salas.isEmpty()){
     ...
     public ActionErrors validate(ActionMapping mapping,
		...
		if (operacion != null && !operacion.equals("next")
			...
			if (mail == null || mail.trim().equals("")) {
				...
				actionErrors.add("empty", new ActionMessage(
						"errors.reservacion"));
			} else if (fecha == null || fecha.trim().equals("")) {
				actionErrors.add("empty", new ActionMessage("errors.fecha"));
			} else if (fecha_fin == null || fecha_fin.trim().equals("")) {
				actionErrors.add("empty", new ActionMessage("errors.fechaFin"));
			}else if (hora == null || hora.equals("0")) {
				actionErrors.add("empty", new ActionMessage("errors.hora"));
			}else if (dia == 0) {
				actionErrors.add("empty", new ActionMessage("errors.dia"));
