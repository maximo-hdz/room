...
<script type="text/javascript">function set(target) {	document.forms[0].elements[0].value=target;}function goAway() {	
if (confirm('Estas seguro de que quieres guardar?')){		set('guardar');		
document.forms[0].submit();	}else {		return false;	}		}</script>
<script type="text/javascript">function abrirWin(){
infSala = document.forms[0].elements['salaSelect'].value;
if(infSala != 7){
window.open('/room/html/sala'+infSala+'.html','DetallaWin','width=600,height=460');
}else{
alert("Por el momento no hay informacion de la sala");
}
}</script>
...
<table align="center" class="tableLine" width="600" cellpadding="0" cellspacing="0" border="0">
  ...
  <html:form action="Reservacion"><html:hidden property="operacion" value=""/> 
  <tr> <td align="right" height="100" width="100%">
    <table align="center" width="100%" cellspacing="0" cellpadding="5">
      ...
      <tr> 
        ...
        <td class="Titulo1"> <html:select property="salaSelect" onchange="set('mostrar');submit();" styleClass="estiloSel" ><html:optionsCollection name="ReservacionFormBean"  property="salas"  /></html:select></td>
        <br>
        <td width="180" align="center" class="Titulo1"> <a href="#" target="_blank" onClick="abrirWin();return false;" onMouseOverrr="abrirWin();return true;"> 
    ...
    <table align="center" cellpadding="2" cellspacing="2" border="0" width="100%">
      ...
      <tr> 
        ...
        <td width="180" align="center" class="Titulo1"> <html:link action="Reservacion" paramId="operacion" paramName="back"><img src="/room/img/botAnte.gif" alt="anterior" width="80" height="20" border="0"></html:link> 
          &nbsp;&nbsp; <html:link action="/Reservacion" paramId="operacion" paramName="next"><img src="/room/img/botSig.gif" alt="siguiente" width="80" height="20" border="0"></html:link>	
        </td>
      ...
      <table align="center" cellpadding="2" cellspacing="2" border="0" width="100%">
        <tr align="center"> 
          <td class="Titulo3">&nbsp; </td>
          <logic:iterate name="ReservacionFormBean" id="dia" property="dias">	
        ...
        <logic:iterate name="ReservacionFormBean" id="row" property="horasDias">	
        <tr> 
        ...
        <td width="35"  bgcolor="#E7E7E7" align="center"> <html:radio  idName="dia" property="option" name="ReservacionFormBean" value="fechaCompletaFirst30" disabled="false"/>	
        </td>
        ...
        <td width="35"  bgcolor="#ffffff" align="center"> <html:radio  idName="dia" property="option" name="ReservacionFormBean" value="fechaCompletaLast30" disabled="false"/>	
        </td>
      ...
      <tr> 
        <td colspan="5" align="center" class="Titulo3"> &nbsp;&nbsp;Duraci&oacute;n 
          (horas): </td>
      <tr> 
        <td align="center" colspan="3" class="Titulo1"> <html:radio property="total" value="1">½&nbsp;&nbsp;&nbsp;&nbsp;</html:radio><html:radio property="total" value="2">1&nbsp;&nbsp;&nbsp;&nbsp;</html:radio><html:radio property="total" value="3">1 
          ½&nbsp;&nbsp;&nbsp;&nbsp;</html:radio><html:radio property="total" value="4">2&nbsp;&nbsp;&nbsp;&nbsp;</html:radio><html:radio property="total" value="5">2 
          ½&nbsp;&nbsp;&nbsp;&nbsp;</html:radio><html:radio property="total" value="6">3&nbsp;&nbsp;&nbsp;&nbsp;</html:radio><html:radio property="total" value="7">3 
          ½&nbsp;&nbsp;&nbsp;&nbsp;</html:radio><html:radio property="total" value="8" >4&nbsp;&nbsp;&nbsp;&nbsp;</html:radio>	
        </td>
      </tr>
      <tr> 
        <td colspan="3">&nbsp;</td>
...
var idSala = document.ReservacionFormBean.salaSelect.value;
if(idSala == '6'){
   document.ReservacionFormBean.mail.value = '';
   document.ReservacionFormBean.departamento.value = '';
   document.ReservacionFormBean.comentario.value = '';

   document.ReservacionFormBean.mail.disabled = true;
   document.ReservacionFormBean.departamento.disabled = true;
   document.ReservacionFormBean.comentario.disabled = true;
   for(x=0; x<8;x++){
      document.ReservacionFormBean.total[x].disabled = true;
   }

}else{
   document.ReservacionFormBean.mail.disabled = false;
   document.ReservacionFormBean.departamento.disabled = false;
   document.ReservacionFormBean.comentario.disabled = false;
   for(x=0; x<8;x++){
      document.ReservacionFormBean.total[x].disabled = false;
   }
}
</script>
